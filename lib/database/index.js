...
const verifyLogin = require('./tables/verifyLogin.js')(database, sequelize.DataTypes);
...
account.hasMany(verifyLogin, {foreignKey: 'account_id'});
verifyLogin.belongsTo(account, {foreignKey: 'account_id'});
