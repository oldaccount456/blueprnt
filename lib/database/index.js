...
const verifyRequest = require('./tables/verifyRequest.js')(database, sequelize.DataTypes);
...
account.hasMany(verifyRequest, {foreignKey: 'account_id'});
verifyRequest.belongsTo(account, {foreignKey: 'account_id'});
